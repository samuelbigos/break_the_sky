...
public class Game3D : Node
{
    ...
    public override void _Ready()
    {
        ...
        {
            BoidBase3D boid = BoidScene.Instance() as BoidBase3D;
            AddChild(boid);
            _allBoids.Add(boid);
    ...
    {
        PickupAdd3D pickup = PickupAddScene.Instance() as PickupAdd3D;
    ...
    public void _Spawn(int id)
    {
        ...
        {
            case 0:
                enemy = EnemyDrillerScene.Instance() as BoidBase3D;
                break;
            case 1:
                enemy = EnemyLaserScene.Instance() as BoidBase3D;
                break;
            case 2:
                enemy = EnemyBeaconScene.Instance() as BoidBase3D;
                break;
            case 3:
                enemy = EnemyCarrierScene.Instance() as BoidBase3D;
                break;
        }
